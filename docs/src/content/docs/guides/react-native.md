...
React Native's built-in `fetch` does not support streaming response bodies. `@strand-js/react-native` patches this transparently so all Strand hooks work identically.
